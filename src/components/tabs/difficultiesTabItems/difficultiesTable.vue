<template>
    <div class="card">
        ...
        <div class="card-content" v-if="showCard">
            ...
            <b-table :data="difficulties" :mobile-cards="hasMobileCards" :paginated="isPaginated"
                     :per-page="perPage" :show-detail-icon="false" aria-current-label="Current page"
                     aria-next-label="Next page" aria-page-label="Page" aria-previous-label="Previous page" detailed
                     hoverable narrowed ref="table" sortable striped>
                <template slot-scope="props">
                    ...
                    <b-table-column field="difficulty.numberOfPhotos" label="Number of photos" numeric sortable>
                        {{ props.row.difficulty.numberOfPhotos }}
                    </b-table-column>
                    <b-table-column field="difficulty.distance" label="Maximum distance" numeric sortable>
