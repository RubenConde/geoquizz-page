        ...
        <section class="card-content" v-if="showCard">
            <div class="columns is-multiline">
                <div class="column is-one-third">
                    ...
                    <b-field>
                        <b-select expanded icon="map-marker" placeholder="Series" size="is-small"
                ...
                <div class="column is-one-third">
                    ...
                    <gmap-map :center="{lat : newPhoto.latitude, lng : newPhoto.longitude}" :options="mapOptions"
                              :zoom="10" class="map">
                        <GmapMarker :draggable="true" :position="{lat : newPhoto.latitude, lng : newPhoto.longitude}"
                                    @dragend="changeMarkerPosition"/>
                    </gmap-map>
                </div>
                <b-button @click="createNewPhoto" size="is-small" type="is-success">Create</b-button>
            </div>
