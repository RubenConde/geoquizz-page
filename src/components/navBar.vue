<template>
   <nav aria-label="main navigation" class="navbar is-primary is-fixed-top" role="navigation">
         ...
         <div class="navbar-end">
            <div class="navbar-item has-dropdown is-hoverable ">
               ...
               <div class="navbar-dropdown is-right">
                  ...
                  <a class="navbar-item" @click="isCardModalActive = !isCardModalActive">
                  ...
                  <a href="https://rubenconde.github.io/geoquizzAPI/" class="navbar-item">
                     API
                  </a>
               </div>
            </div>
      ...
      <b-modal :active.sync="isCardModalActive" :width="500" :can-cancel="[]">
         <score-table @close="isCardModalActive = !isCardModalActive"></score-table>
      </b-modal>
      <b-modal :active.sync="isInstructions" :width="500" :can-cancel="[]">
         <instructions @close="isInstructions = !isInstructions"></instructions>
      </b-modal>
   </nav>
</template>
